...
export const MDXComponents = {
  ...
  hr: (props: ChakraProps) => <chakra.hr my={64} {...props} />,
  ...
  th: THead,
  td: TData,
  a: (props: ChakraProps) => <Link color='teal.500' _dark={{ color: 'teal.200' }} {...props} />,
  p: (props: ChakraProps) => <Text apply='mdx.p' {...props} />,
