...
const PostCard = ({ post, index }: { post: Post; index: number }) => {
  ...
  return (
    <div className='group mb-6'>
      <Link href={slug}>
        <div className='mb-5 rounded-lg ring-mauve-200 ring-offset-4 ring-offset-base-200 duration-300 group-hover:ring-2 dark:ring-mauve-100 dark:ring-offset-base-100'>
          {image && (
            <Image
